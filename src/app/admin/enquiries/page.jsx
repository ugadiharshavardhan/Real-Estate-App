        ...
        {enquiries.length === 0 ? (
          ...
          enquiries.map((enquiry) => (
            ...
            >
              ...
              {/* Project Interest */}
              {/* ... (keep existing project interest content) */}
              ...
              <div className="flex items-center gap-4 ml-auto lg:ml-0">
                ...
                />
                <button className="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-50 text-gray-400 hover:bg-gray-100 hover:text-gray-900 transition-all">
