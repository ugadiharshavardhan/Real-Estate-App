      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-playfair font-bold text-gray-900 mb-6 relative inline-block">
              Project Overview
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-12">
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 text-center hover:shadow-md transition-shadow">
                ...
                <p className="text-3xl lg:text-4xl font-bold font-playfair text-[#1B4332] mb-2">
                  {project.totalAcres}+
                </p>
