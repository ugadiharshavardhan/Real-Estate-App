...
export default function HeroCarousel() {
  const slides = [
    ...
    },
    {
      ...
      headline: "Serenity in Every Corner",
      sub: "Thoughtfully crafted interiors illuminated by natural light.",
    },
  ];
    ...
    <div className="relative w-full h-screen overflow-hidden bg-[#1B4332]">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute left-0 top-0 h-full w-2/3 bg-gradient-to-r from-black/85 via-black/60 to-transparent" />
          ...
          <div className="relative z-10 w-full h-full flex items-end py-10 px-6 md:px-16 mx-auto">
            <div className="text-left max-w-4xl">
              ...
              >
                <button className="px-8 py-3 bg-[#1B4332] text-white font-medium rounded-full hover:bg-green-900 transition-colors flex items-center justify-center gap-2 group">
                  Explore Projects
                  <ArrowRight
                    size={18}
                ...
                <button className="px-8 py-3 bg-white/10 backdrop-blur-sm border border-white/30 text-white font-medium rounded-full hover:bg-white/20 transition-colors">
                  Contact Us
                </button>
              </motion.div>
            </div>
